                ...
                ColumnLayout {
                    ...
                    IconImage {
                        ...
                        function updateIcon() {
                            ...
                            if (muted) {
                                return "/home/zenflow/ZenFlow/.config/quickshell/icons/speakers/speaker-simple-none.svg";
                            }

                            // Then check volume levels
                            if (volume > 0.9) {
                                return "/home/zenflow/ZenFlow/.config/quickshell/icons/speakers/speaker-simple-high.svg";
                            } else if (volume > 0.5) {
                                return "/home/zenflow/ZenFlow/.config/quickshell/icons/speakers/speaker-simple-high.svg";
                            } else if (volume > 0.3) {
                                return "/home/zenflow/ZenFlow/.config/quickshell/icons/speakers/speaker-simple-low.svg";
